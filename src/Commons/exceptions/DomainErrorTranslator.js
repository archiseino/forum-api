...
DomainErrorTranslator._directories = {
  ...
  'COMMENT_DETAIL.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
    'tidak dapat menampilkan detail comment karena properti yang dibutuhkan tidak ada'
  ),
  'COMMENT_DETAIL.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
    'tidak dapat menampilkan detail comment karena tipe data tidak sesuai'
  ),
  ...
  'REPLY_DETAIL.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
    'tidak dapat menampilkan detail reply karena properti yang dibutuhkan tidak ada'
  ),
  'REPLY_DETAIL.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
    'tidak dapat menampilkan detail reply karena tipe data tidak sesuai'
  ),
};
